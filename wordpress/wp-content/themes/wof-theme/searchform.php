...
<div id="main-searchbar" class="searchbar">
    <div id="searchbar-searchbox" class="searchbar-searchbox">
        <div></div>
        <div class="searchbar-btn-wrap searchbar-submit-btn-wrap">
            <button id="searchbar-submit-btn" class="searchbox-btn">
        ...
        <div class="searchbar-btn-wrap searchbar-clear-btn-wrap">
            <button id="searchbar-clear-btn" class="searchbox-btn">
    ...
    <div id="searchbar-hits" class="searchbar-hits"></div>
</div>
